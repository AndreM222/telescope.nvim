...
function Previewer:send_input(input)
  if self._send_input then
    ...
    vim.api.nvim_err_writeln(Msgstr("send_input is not defined for this previewer"))
  end
end
...
function Previewer:scroll_fn(direction)
  if self._scroll_fn then
    ...
    vim.api.nvim_err_writeln(Msgstr("scroll_fn is not defined for this previewer"))
  end
end
...
function Previewer:scroll_horizontal_fn(direction)
  if self._scroll_horizontal_fn then
    ...
    vim.api.nvim_err_writeln(Msgstr("scroll_horizontal_fn is not defined for this previewer"))
  end
end
